const en = {
  ...
  "manifesto": {
    ...
    "text2": "we build it",
    "text3": ". Every system, every distributed network, every IoT deployment is a step toward a world where",
    "text4": "technology doesn't just serve humanity—it amplifies human potential exponentially"
  },
  "selection": {
    "label": "02 // Selection",
    "title": "We choose 8 per year. Maximum.",
    "description": "Not because we can't handle more. Because breakthrough innovation requires our complete focus. Each project gets the full weight of our expertise, our embedded engineering prowess, and our obsessive attention to technical excellence.",
    "criteria": {
      "technical": {
  ...
  "form": {
    ...
    "success_desc": "Our engineering team will evaluate your project within 48 hours.",
    "fields": {
      "name": {
        "label": "$ whoami --name",
      ...
      "message": {
        ...
        "placeholder": "Technical specifications, scale requirements, timeline, budget range, and why this project requires IMPULSE's expertise...\n\nExample structure:\n- Problem Statement\n- Technical Complexity\n- Scale Requirements  \n- Innovation Impact\n- Timeline & Budget\n- Why IMPULSE?",
